...
import { Box, Button, Typography, TextField, IconButton, Grid, Divider, Paper, Tooltip } from '@mui/material';
...
const QuestionPage = () => {
    ...
    return (
        <Box sx={{ padding: '100px', backgroundColor: theme.palette.background.paper }}>
            <Box sx={{ padding: '20px', maxWidth: '900px', margin: 'auto', backgroundColor: theme.palette.background.paper, color: theme.palette.text.primary }}>
                {/* Question Title */}
